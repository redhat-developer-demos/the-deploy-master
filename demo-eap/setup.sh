...
oc new-app --name demo jboss-eap70-openshift~https://github.com/redhat-developer-demos/the-deploy-master --context-dir=/demo
#Create the application BLUE
oc new-app --name demo-blue jboss-eap70-openshift~https://github.com/redhat-developer-demos/the-deploy-master --context-dir=/demo
